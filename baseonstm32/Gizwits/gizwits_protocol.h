...
* @{
*/
#define PRODUCT_KEY "7cf8dc7ef03648fa8f7400a0c44b5754"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "c5240db77b3943a4982f3dabf5f5c001"
...
* @{
*/
#define heart_alarm_BYTEOFFSET                    26
#define heart_alarm_BITOFFSET                     0
#define heart_alarm_LEN                           1
#define spo2_alarm_BYTEOFFSET                    26
#define spo2_alarm_BITOFFSET                     1
#define spo2_alarm_LEN                           1

#define set_heartH_RATIO                         1
#define set_heartH_ADDITION                      0
#define set_heartH_MIN                           0
#define set_heartH_MAX                           120
#define set_heartL_RATIO                         1
#define set_heartL_ADDITION                      0
#define set_heartL_MIN                           0
#define set_heartL_MAX                           120
#define set_spo2H_RATIO                         1
#define set_spo2H_ADDITION                      0
#define set_spo2H_MIN                           0
#define set_spo2H_MAX                           120
#define set_spo2L_RATIO                         1
#define set_spo2L_ADDITION                      0
#define set_spo2L_MIN                           0
#define set_spo2L_MAX                           120
#define heart_RATIO                         1
#define heart_ADDITION                      0
#define heart_MIN                           0
#define heart_MAX                           120
#define spo2_RATIO                         1
...
typedef struct {
  uint32_t valueset_heartH;
  uint32_t valueset_heartL;
  uint32_t valueset_spo2H;
  uint32_t valueset_spo2L;
  uint32_t valueheart;
  uint32_t valuespo2;
  uint8_t valueheart_hisdata[10];
  uint8_t valuespo2_hisdata[10];
  bool valueheart_alarm;
  bool valuespo2_alarm;
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */ 
typedef struct {
  uint8_t flagset_heartH:1;
  uint8_t flagset_heartL:1;
  uint8_t flagset_spo2H:1;
  uint8_t flagset_spo2L:1;
} attrFlags_t;
...
typedef struct {
  uint8_t valueset_heartH;
  uint8_t valueset_heartL;
  uint8_t valueset_spo2H;
  uint8_t valueset_spo2L;
} attrVals_t;
